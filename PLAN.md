...
- **実装方針**:
  ...
  ```
- **受け入れ基準**:
  - [ ] PCシミュレータが起動し、無限ループでtick()を呼ぶ
  - [ ] Ctrl+Cで終了可能
  - [ ] 標準出力にGPIO/I2Cログが出力される
...
- **受け入れ基準**:
  - [ ] ビルドが成功
  - [ ] PCシミュレータが起動し、LED点滅・I2Cログが出力される
  - [ ] 基本的な動作が目視確認できる
...
- **受け入れ基準**:
  - [ ] READMEを読めばプロジェクトの全体像が理解できる
  - [ ] PC/ESP32両方の環境構築手順が明確
  - [ ] 配線図等のハードウェア情報が含まれる
