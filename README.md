...
`scripts/dev-loop.sh` を使うと、ファイル変更を監視しながら simulator を自動再起動できます。

```bash
# simulator をウォッチモードで起動
./scripts/dev-loop.sh
```
...
│   │   ├── README.md
│   │   ├── bme280.rs          # BME280 temperature / humidity / pressure driver
│   │   ├── bh1750.rs          # BH1750 ambient light sensor driver
│   │   ├── dht22.rs           # DHT22 temperature / humidity driver
│   │   ├── ds3231.rs          # DS3231 RTC driver
│   │   ├── hc_sr04.rs         # HC-SR04 distance driver
│   │   ├── lcd1602.rs         # LCD1602 backpack driver
│   │   ├── mpu6050.rs         # MPU6050 IMU driver
│   │   ├── sgp30.rs           # SGP30 VOC / CO2 driver
│   │   ├── ssd1306.rs         # SSD1306 OLED display driver
│   │   ├── vl53l0x.rs         # VL53L0X ToF distance driver
│   │   ├── servo.rs           # servo PWM driver
│   │   ├── l298n.rs           # L298N dual motor driver
│   │   ├── esp32_cam.rs       # ESP32-CAM camera capture (stub)
│   │   └── lib.rs
│   │
